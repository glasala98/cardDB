...
CMD ["sh", "-c", "python migrations/migrate_add_raw_sales_created_at.py && python migrations/migrate_autovacuum_tuning.py && python migrations/migrate_add_ebay_tables.py && uvicorn api.main:app --host 0.0.0.0 --port ${PORT:-8000} --workers 1"]
